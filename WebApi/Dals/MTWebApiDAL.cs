    ...
    public class MTWebApiDAL
    {
        ...
        public ReturnModel<string> UploadAdvSwapFeePositions(string MainLableName,string MTType,List<AdvSwapFeePositionInfo> PositionList)
        {
            ...
            try
            {
                ...
                {
                    lstSql.Add($"INSERT INTO RiskManagement_AdvSwapFeePositions(`Position`,`MainLableName`,`MTType`,`TimeStamp`,`Login`,`Symbol`,`ProfitCurrency`,`Volume`,`Entry`,`StorageMode`,`StorageLong`,`StorageShort`,`PriceOpen`,`PriceCurrent`,`ProfitRate`,`StorageBefore`,`Storage`,`UpdateTime`) VALUES({pos.Position},'{MainLableName}','{MTType}',{pos.TimeStamp},{pos.Login},'{pos.Symbol}','{pos.ProfitCurrency}',{pos.Volume},'{pos.Entry}',{pos.StorageMode},{pos.StorageLong},{pos.StorageShort},{pos.PriceOpen},{pos.PriceCurrent},{pos.ProfitRate},{pos.StorageBefore},{pos.Storage},'{CurrentTime}') ON DUPLICATE KEY UPDATE `Login`={pos.Login},`Symbol`='{pos.Symbol}',`ProfitCurrency`='{pos.ProfitCurrency}',`Volume`={pos.Volume},`Entry`='{pos.Entry}',`StorageMode`={pos.StorageMode},`StorageLong`={pos.StorageLong},`StorageShort`={pos.StorageShort},`PriceOpen`={pos.PriceOpen},`PriceCurrent`={pos.PriceCurrent},`ProfitRate`={pos.ProfitRate},`StorageBefore`={pos.StorageBefore},`Storage`={pos.Storage},`UpdateTime`='{CurrentTime}'");
                });
