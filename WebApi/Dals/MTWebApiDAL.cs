        ...
        public ReturnModel<string> UploadAdvSwapFeePositions(string MainLableName,string MTType,List<AdvSwapFeePositionInfo> PositionList)
        {
            ...
            try
            {
                ...
                PositionList.ForEach(pos =>
                {
                    ...
                    lstSql.Add($"INSERT INTO RiskManagement_AdvSwapFeePositions(`Position`,`MainLableName`,`MTType`,`TimeStamp`,`Login`,`Symbol`,`ProfitCurrency`,`Volume`,`Entry`,`StorageMode`,`StorageLong`,`StorageShort`,`PriceOpen`,`PriceCurrent`,`ProfitRate`,`StorageBefore`,`Storage`,`GatewayEntry`,`GatewayVolume`,`GatewayPrice`,`Reason`,`OpenTimeStamp`,`OpenTime`,`ExpertID`,`ExternalID`,`Comment`,`PriceSL`,`PriceTP`,`Profit`,`PriceMargin`,`UpdateTime`) VALUES({pos.Position},'{MainLableName}','{MTType}',{pos.TimeStamp},{pos.Login},'{pos.Symbol}','{pos.ProfitCurrency}',{pos.Volume},'{pos.Entry}',{pos.StorageMode},{pos.StorageLong},{pos.StorageShort},{pos.PriceOpen},{pos.PriceCurrent},{pos.ProfitRate},{pos.StorageBefore},{pos.Storage},{pos.GatewayEntry},{pos.GatewayVolume},{pos.GatewayPrice},{pos.Reason},{pos.OpenTimeStamp},'{openTime.ToString("yyyy-MM-dd HH:mm:ss:ffff")}',{pos.ExpertID},'{pos.ExternalID}','{pos.Comment.Replace("'","''")}',{pos.PriceSL},{pos.PriceTP},{pos.Profit},{pos.PriceMargin},'{CurrentTime}')");
                });
